...
| `GCT_FUNDING_RESEARCH_CORE_ASSETS` | 38 个龙头 | 常驻轻量发现，不代表常驻完整订单簿 |
| `GCT_FUNDING_RESEARCH_SATELLITE_ASSETS` | 55 个高费率候选 | 卫星池按评分竞争盘口热池，建议保持 40–60 个 |
...
| `GCT_FUNDING_RESEARCH_MODEL_VERSION` | `rolling_v8` | 当前研究账本版本；包含真实最终费率、四实验组和多周期生存模型 |
...
GCT_FUNDING_RESEARCH_CORE_ASSETS=BTC,ETH,SOL,XRP,ZEC,BNB,SNDK,UNITREE,PUMP,SUI,ONDO,MSTRX,APT,TAO,LIT,LINK,AAVE,LDO,PYTH,HYPE,ARB,COINX,CRV,NVDAX,GOOGLX,MSFT,WLFI,IO,AI,AERO,ASTER,UNI,AKT,SKY,ZK,MORPHO,BREV,SKHYNIX
GCT_FUNDING_RESEARCH_SATELLITE_ASSETS=DOGE,ADA,AVAX,LTC,BCH,DOT,NEAR,OP,INJ,ATOM,FIL,ETC,XLM,HBAR,TRX,SEI,JUP,WIF,PEPE,TON,SHIB,POL,EOS,GALA,SAND,MANA,RUNE,IMX,STX,TIA,ENA,WLD,ORDI,NOT,FET,ICP,DYDX,GMX,KAS,ALGO,VET,FLOW,THETA,MKR,COMP,SNX,BONK,FLOKI,POPCAT,PENGU,TRUMP,KAITO,PENDLE,JTO,STRK
...
GCT_FUNDING_RESEARCH_MODEL_VERSION=rolling_v8
