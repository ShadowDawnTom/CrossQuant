...
| `GCT_FUNDING_RESEARCH_ASSETS` | 31 个研究候选币（包含 ZEC） | 研究资产；启用时必须同时配置对应执行订单簿，最多 50 个 |
...
| `GCT_FUNDING_RESEARCH_MODEL_VERSION` | `rolling_v3` | 当前研究账本版本；切换版本会隔离统计并归档旧版未平模拟仓位 |
| `GCT_FUNDING_RESEARCH_HOLD_EXIT_CONFIRMATIONS` | `60` | 第一次双腿结算后，继续持有价值不为正的连续有效扫描确认数，默认约 60 分钟 |
| `GCT_FUNDING_RESEARCH_REVERSAL_EXIT_CONFIRMATIONS` | `30` | 滚动组资金费方向反转的连续有效扫描确认数，默认约 30 分钟 |
...
GCT_EXECUTION_MARKET_SYMBOLS=BTC,ETH,SOL,XRP,DOGE,ADA,SUI,AVAX,LINK,LTC,BCH,DOT,UNI,AAVE,NEAR,APT,ARB,OP,INJ,ATOM,FIL,ETC,XLM,HBAR,TRX,SEI,JUP,TAO,WIF,PEPE,ZEC
GCT_FUNDING_SCAN_ASSETS=BTC,ETH,SOL
GCT_FUNDING_RESEARCH_ENABLED=1
GCT_FUNDING_RESEARCH_ASSETS=BTC,ETH,SOL,XRP,DOGE,ADA,SUI,AVAX,LINK,LTC,BCH,DOT,UNI,AAVE,NEAR,APT,ARB,OP,INJ,ATOM,FIL,ETC,XLM,HBAR,TRX,SEI,JUP,TAO,WIF,PEPE,ZEC
GCT_FUNDING_RESEARCH_TARGET_NOTIONAL_USD=5
GCT_FUNDING_RESEARCH_MAX_OPEN_POSITIONS=1
GCT_FUNDING_RESEARCH_MODEL_VERSION=rolling_v3
GCT_FUNDING_RESEARCH_HOLD_EXIT_CONFIRMATIONS=60
GCT_FUNDING_RESEARCH_REVERSAL_EXIT_CONFIRMATIONS=30
